...
public class DialogoMentoria {
    ...
    private Participante mentor; // Relacionamento com o Mentor

    @ManyToOne
    @JoinColumn(name = "participante_mentee_fk", referencedColumnName = "id", nullable = false)
    private Participante mentee; // Relacionamento com o Mentee
    ...
    public Participante getMentor() {
        return mentor;
    }

    public void setMentor(Participante mentor) {
        this.mentor = mentor;
    }

    public Participante getMentee() {
        return mentee;
    }

    public void setMentee(Participante mentee) {
        this.mentee = mentee;
    }
